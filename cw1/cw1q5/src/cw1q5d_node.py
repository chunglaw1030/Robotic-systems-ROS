...
# youbot_dh_parameters = {'a': [0.024+0.033,  0.155, 0.135, 0, -0.002],
#                         'alpha': [ np.pi/2, 0, 0, -np.pi/2, 0],
#                         'd' : [0.096+0.019 ,0, 0, 0, 0.130],
#                         'theta' : [np.pi/2, np.pi/2, 0, -np.pi/2, 0]}

# youbot_dh_parameters = {'a': [-0.024-0.033,  0.155, 0.135, 0, -0.002],
#                         'alpha': [ np.pi/2 + np.pi, 0, 0, np.pi+np.pi/2, 0],
#                         'd' : [0.096+0.019 ,0, 0, 0, -0.130],
#                         'theta' : [0 , 0, np.pi, 0, 0]}
...
youbot_joint_offsets = [170*np.pi/180, 65*np.pi/180, -146*np.pi/180, 102.5*np.pi/180, 167.5*np.pi/180]
...
name_link = ['arm5d_link_1','arm5d_link_2','arm5d_link_3','arm5d_link_4','arm5d_link_5','arm5d_link_6']
